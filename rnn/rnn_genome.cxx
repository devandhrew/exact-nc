...
void RNN_Genome::write_predictions(const vector<string> &input_filenames, const vector<double> &parameters, const vector< vector< vector<double> > > &inputs, const vector< vector< vector<double> > > &outputs, const double &threshhold) {
    RNN *rnn = get_rnn();
    rnn->set_weights(parameters);
