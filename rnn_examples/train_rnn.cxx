...
int main(int argc, char **argv) {
    ...
    if (rnn_type == "one_layer_lstm") {
        ...
        genome = create_lstm(number_inputs, 5, number_inputs, number_outputs, max_recurrent_depth);
    ...
    string search_type;
    get_argument(arguments, "--search_type", false, search_type);
    ...
    cout << endl;
    genome->write_to_file("unoptimtized_10.bin",true);
}
