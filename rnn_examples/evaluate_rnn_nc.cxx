...
int main(int argc, char** argv) {
    ...
    double threshhold;
    get_argument(arguments, "--threshhold", false, threshhold);
...
//    cout << "normalized time series." << endl;
    ...
    genome->write_predictions(testing_filenames, best_parameters, testing_inputs, testing_outputs, threshhold);
    

//int_coverage_table(genome);
    /*
    int length;
    char *byte_array;
