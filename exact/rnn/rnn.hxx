...
class RNN {
    ...
    public:
        ...
        void forward_pass(const vector< vector<double> > &series_data, bool using_dropout, bool training, double dropout_probability, int32_t threshhold);
        ...
        //Node Coverage
        void update_node_coverage(int32_t time, map<std::tuple<double,int32_t>,bool> model_dict, int32_t threshhold);
        ...
        void write_predictions(string output_filename, const vector<string> &input_parameter_names, const vector<string> &output_parameter_names, const vector< vector<double> > &series_data, const vector< vector<double> > &expected_outputs, bool using_dropout, double dropout_probability, const int32_t &threshhold);
